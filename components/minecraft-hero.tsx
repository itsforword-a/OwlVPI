...
import { Mingzat as Minecraft } from "next/font/google"
...
function CopyIPButton() {
  ...
  const serverIP = "play.viewpoint.mc"
...
export default function MinecraftHero({
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#0a0f0a]">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-green-300 tracking-wide font-mono">Minecraft {version}</span>
          </motion.div>
          ...
          <motion.div custom={3} variants={fadeUpVariants} initial="hidden" animate="visible">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <CopyIPButton />
              <div className="text-green-400/60 text-sm font-mono">Нажмите, чтобы скопировать IP</div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="mt-12 flex flex-wrap justify-center gap-4 text-sm text-green-300/50"
          >
            <span className="px-3 py-1 bg-green-900/20 rounded border border-green-500/20">🌱 Ванильное выживание</span>
            <span className="px-3 py-1 bg-green-900/20 rounded border border-green-500/20">
              🏠 Приватные территории
            </span>
            <span className="px-3 py-1 bg-green-900/20 rounded border border-green-500/20">⚔️ PvP зоны</span>
            <span className="px-3 py-1 bg-green-900/20 rounded border border-green-500/20">🎯 Ежедневные квесты</span>
          </motion.div>
        </div>
      </div>
